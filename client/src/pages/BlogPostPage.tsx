            ...
            <div className="w-full h-[300px] md:h-[450px] lg:h-[500px] rounded-3xl overflow-hidden mb-12 bg-stone-100 flex items-center justify-center relative shadow-sm border border-stone-200/50">
              ...
              {post.imageUrl ? (
                ...
                <div className="text-center p-8">
                  <span className="text-stone-300 font-serif italic text-2xl md:text-4xl opacity-40 font-bold tracking-wider">
                    Annise Herbal
                  </span>
                </div>
              )}
              ...
              {post.translations[lang].content.map((paragraph, index) => {
                ...
                if (isHeading) {
                  return (
                    <h3
                      key={index}
                      className="text-2xl md:text-3xl font-serif font-bold text-[#1c1209] mt-12 mb-6 leading-snug"
                    >
                      {paragraph}
                    </h3>
                  );
                ...
                if (index === 0 && paragraph.length > 50) {
                  return (
                    <p
                      key={index}
                      className="leading-relaxed mb-8 text-xl md:text-2xl font-serif text-[#1c1209]/80"
                    >
                      {paragraph}
                    </p>
                  );
                ...
                return (
                  <p
                    key={index}
                    className="text-stone-700 leading-relaxed mb-6 font-medium text-[1.05rem] md:text-lg"
                  >
                    {paragraph}
                  </p>
                );
